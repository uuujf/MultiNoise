...
parser.add_argument('--ghostsize', type=int, default=500)
...
parser.add_argument('--datadir', type=str, default='/mnt/wjf/datasets/CIFAR100/numpy')
parser.add_argument('--logdir', type=str, default='logs/SGDF')
